<template>
    <div :class="$style.root">
        <transition :name="transitionName">
            <div :class="$style.backtotop" @click="backToTop" v-show="visible" :style="customStyle">
            <svg width="16" height="16" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" :class="$style.Icon" class="Icon--backToTopArrow" aria-hidden="true" style="height: 16px; width: 16px;">
                <title>回到顶部</title>
                <g>
